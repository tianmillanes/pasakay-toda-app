...
class RideHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (authService.currentUser == null) {
      return const Center(
        child: Text('Please log in to view ride history',
    ...
    return StreamBuilder<List<RideModel>>(
      ...
      builder: (context, snapshot) {
        ...
        final double totalSpent = completedRides.fold(0, (sum, ride) => sum + ride.fare);
        final int totalRides = completedRides.length;
                    ...
                    if (ride.isRated)
                      Row(
                        children: [
                          ...
                          Text(
                            ride.rating?.toStringAsFixed(1) ?? '5.0',
                        ...
                        onPressed: () {
                          ...
                          showDialog(
                            ...
                            builder: (context) => DriverRatingDialog(
                              ...
                              isPasabuy: ride.isPasaBuy, // if it happens to be, but history screens are usually separated
                            ),
                          );
                        },
                      ),
